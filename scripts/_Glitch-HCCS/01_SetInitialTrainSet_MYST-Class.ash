...
void main()
{
	...
	wait(1);
		visit_url("choice.php?pwd&whichchoice=1485&option=1&slot[0]=3&slot[1]=8&slot[2]=16&slot[3]=17&slot[4]=14&slot[5]=1&slot[6]=7&slot[7]=20",true,true);
	
		// Allstat -> coal -> mys -> mus -> mox -> meat -> candy -> ore
