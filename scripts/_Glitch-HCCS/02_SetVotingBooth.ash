// Glitch's HCCS scripting project: Voting Booth Script (directly stolen from the amazing Ezandora)
// https://github.com/Ezandora/Voting-Booth
// ***************************
//          To Do            *
// ***************************
// 
...
boolean __voting_setting_confirm_initiatives_in_run = true; //set this to true if you want a confirmation box before we vote. or just vote by hand
